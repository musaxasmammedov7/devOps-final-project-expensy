...
| **2** | [expensy-secrets-app.yaml](file:///Users/musaxasmammedov/devops/devOps-final-project-expensy/gitops/apps/expensy-secrets-app.yaml) | `expensy-secrets` | ExternalSecret ресурсы приложения. Создают Kubernetes Secrets для MongoDB, Redis и backend до запуска workload'ов. |
...
| **3** | [expensy-mongodb-app.yaml](file:///Users/musaxasmammedov/devops/devOps-final-project-expensy/gitops/apps/expensy-mongodb-app.yaml) | `expensy-mongodb` | СУБД MongoDB. Использует уже созданный `mongodb-root-password-secret`. |
| **3** | [expensy-redis-app.yaml](file:///Users/musaxasmammedov/devops/devOps-final-project-expensy/gitops/apps/expensy-redis-app.yaml) | `expensy-redis` | Хранилище Redis. Использует уже созданный `redis-password-secret`. |
| **4** | [expensy-app.yaml](file:///Users/musaxasmammedov/devops/devOps-final-project-expensy/gitops/apps/expensy-app.yaml) | `expensy-apps` | Микросервисы приложения Expensy (backend, frontend). Разворачиваются в последнюю очередь после готовности баз данных и секретов. |
